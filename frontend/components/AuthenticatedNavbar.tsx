      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <nav className="flex items-center gap-3 text-sm text-slate-600">
          {isAuthenticated ? <>
            ...
            <Link href="/dashboard" className="rounded-full px-3 py-2 hover:bg-slate-100">Dashboard</Link>
            <Link href="/tests" className="rounded-full px-3 py-2 hover:bg-slate-100">Tests</Link>
